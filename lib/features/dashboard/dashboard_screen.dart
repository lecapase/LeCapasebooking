...
class _DashboardScreenState extends State<DashboardScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(color: Color(0xFFC8A45D), fontSize: 16),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: const [
                      Icon(Icons.warning_amber, color: Colors.white, size: 34),
                      SizedBox(width: 15),
                      Expanded(
                        child: Text(
                          'PRENOTAZIONI\nDA GESTIRE',
                      ...
                      Icon(Icons.chevron_right, color: Colors.black, size: 34),
                    ],
                  ),
                ),
              ),
  ...
  Widget _statCard({
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(icon, color: const Color(0xFFC8A45D), size: 34),
